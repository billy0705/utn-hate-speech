...
def analyze_dataset_correspondence():
    ...
    try:
        ...
        # Find the intersection of all Group_IDs (common across all languages)
        ...
        if len(all_languages) > 1:
            ...
            # Find Group_IDs unique to each language
        ...
        # Find Group_IDs missing from each language
        ...
        # Analyze specific Group_IDs that appear in some languages but not others
        print(f"\nDetailed Analysis of Non-Common Group_IDs:")
        print("-" * 60)
        
        # Find Group_IDs that appear in at least one but not all languages
        ...
        if len(partial_group_ids) > 0:
            ...
            # Show which languages each partial Group_ID appears in
            for group_id in sorted(list(partial_group_ids))[:10]:  # Show first 10
                ...
                # Show a sample text for this Group_ID
...
if __name__ == "__main__":
    ...
    if results:
        ...
        if not results['correspondence_complete']:
            ...
            print(f"   This means your consistency analysis will show inconsistencies")
